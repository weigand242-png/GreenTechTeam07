...
## Our product
A plattform that gives advises on when to charge and when feed power into the grid, so that fleet managers can gain money, whilst standing pluged in at the company base.

## Thinks we considered and Guide lines:
